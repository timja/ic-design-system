...
export const withReactRouter = [
  ...
  <div style={{ display: "flex", flexDirection: "row"}}>
    ...
    <main>
      <IcSectionContainer>
        <Routes>
          <Route path="/" element={el('This is the Home page')} />
          <Route path="/search" element={el('Search')} />
          <Route path="/drinks" element={el('Drinks')} />
          <Route path="/coffee-maker" element={el('Coffee Maker')} />
...
export const basicLayoutFixedViewport = [
  {
    technology: "Web component",
    snippets: {
      short: `<div style="display: flex; height:100%;">
  <ic-side-navigation
