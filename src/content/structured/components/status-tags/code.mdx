...
export const snippetsEmphasis = [
  {
    technology: "Web component",
    snippets: {
      short: `<ic-status-tag label="Neutral" status="neutral" variant="outlined"></ic-status-tag>
...
export const snippetsSmall = [
  {
    technology: "Web component",
    snippets: {
      short: `<ic-status-tag label="Neutral" status="neutral" size="small"></ic-status-tag>
